					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {server: a, registration: b, client: c, userTimeline: d, localTimeline: e, publicTimeline: f, draft: g, account: h, errors: i, location: j};
									};
								};
							};
						};
					...
					if (_p21.ctor === 'Just') {
						return {
							...
							_0: A2(
								...
								A2(_n1k0$tooty$Mastodon$getAccessToken, _p21._0, _p20._0)),
							_1: {ctor: '[]'}
						};
					} else {
						return {ctor: '[]'};
...
var _n1k0$tooty$View$draftView = function (_p13) {
	var _p14 = _p13;
	var _p23 = _p14.draft;
	var visibilityOptionView = function (_p15) {
		var _p16 = _p15;
		var _p17 = _p16._0;
		return A2(
	...
	var hasSpoiler = !_elm_lang$core$Native_Utils.eq(_p23.spoiler_text, _elm_lang$core$Maybe$Nothing);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
																	...
																	_0: _elm_lang$html$Html_Events$onCheck(
																		function (_p18) {
																			return _n1k0$tooty$Model$DraftEvent(
																				_n1k0$tooty$Model$ToggleSpoiler(_p18));
																		}),
																	_1: {
																		ctor: '::',
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_0: _elm_lang$html$Html_Events$onInput(
																					function (_p19) {
																						return _n1k0$tooty$Model$DraftEvent(
																							_n1k0$tooty$Model$UpdateSpoiler(_p19));
																					}),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$required(true),
																					_1: {
																						...
																						_0: _elm_lang$html$Html_Attributes$value(
																							A2(_elm_lang$core$Maybe$withDefault, '', _p23.spoiler_text)),
																						_1: {ctor: '[]'}
																					}
																				}
																			}
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_0: _elm_lang$html$Html_Events$onInput(
																						function (_p20) {
																							return _n1k0$tooty$Model$DraftEvent(
																								_n1k0$tooty$Model$UpdateStatus(_p20));
																						}),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$required(true),
																						_1: {
																							ctor: '::',
																							_0: _elm_lang$html$Html_Attributes$value(_p23.status),
																							_1: {ctor: '[]'}
																						}
																					}
																				}
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_0: _elm_lang$html$Html_Events$onInput(
																					function (_p21) {
																						return _n1k0$tooty$Model$DraftEvent(
																							_n1k0$tooty$Model$UpdateVisibility(_p21));
																					}),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$required(true),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$value(_p23.visibility),
																						_1: {ctor: '[]'}
																					}
																				}
																			}
																			...
																			_elm_lang$html$Html$input,
																			{
																				...
																				_1: {
																					...
																					_0: _elm_lang$html$Html_Events$onCheck(
																						function (_p22) {
																							return _n1k0$tooty$Model$DraftEvent(
																								_n1k0$tooty$Model$UpdateSensitive(_p22));
																						}),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$checked(_p23.sensitive),
																						_1: {ctor: '[]'}
																					}
																				}
																			},
					...
					_1: {
						...
						_0: function () {
							...
							if (_p24.ctor === 'Just') {
								...
								return A3(_n1k0$tooty$View$timelineView, model.publicTimeline, 'Public timeline', 'globe');
							}
						}(),
						_1: {ctor: '[]'}
					}
