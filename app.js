					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								_n1k0$tooty$Mastodon$fetchNotifications(_p6)),
							_1: {ctor: '[]'}
						}
					}
				}
						...
						if (_p16.ctor === 'Just') {
							return {
								...
								_0: A2(
									...
									A2(_n1k0$tooty$Mastodon$fetchAccount, _p16._0, _p10._0)),
								_1: {ctor: '[]'}
							};
						} else {
							return {ctor: '[]'};
				...
				if (_p19.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								account: _elm_lang$core$Maybe$Just(_p19._0)
							}),
						{ctor: '[]'});
				} else {
					return A2(
					...
					if (_p22.ctor === 'Just') {
						return {
							...
							_0: A2(
								...
								A2(_n1k0$tooty$Mastodon$getAccessToken, _p22._0, _p21._0)),
							_1: {ctor: '[]'}
						};
					} else {
						return {ctor: '[]'};
...
var _n1k0$tooty$View$draftView = function (_p20) {
	var _p21 = _p20;
	var _p30 = _p21.draft;
	var visibilityOptionView = function (_p22) {
		var _p23 = _p22;
		var _p24 = _p23._0;
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(_p24),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_p24,
						A2(_elm_lang$core$Basics_ops['++'], ': ', _p23._1))),
				_1: {ctor: '[]'}
			});
	};
	var hasSpoiler = !_elm_lang$core$Native_Utils.eq(_p30.spoiler_text, _elm_lang$core$Maybe$Nothing);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
